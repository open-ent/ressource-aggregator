...
public interface SignetService {
     ...
     * @param signet JsonObject data
     */
    Future<JsonObject> update(String signetId, JsonObject signet);
     ...
     * @param groupsAndUserIds list of neo ids including the connected user
     */
    Future<JsonArray> getAllMySignetRights(List<String> groupsAndUserIds);
    Future<JsonArray> getAllSignetRights();
